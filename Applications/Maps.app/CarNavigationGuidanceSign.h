...
@interface CarNavigationGuidanceSign : UIView <CarGuidanceCard>
{
    ...
    CarManeuverView *_compressedPrimaryManuever;
...
@property(retain, nonatomic) CarManeuverView *compressedPrimaryManuever; // @synthesize compressedPrimaryManuever=_compressedPrimaryManuever;
