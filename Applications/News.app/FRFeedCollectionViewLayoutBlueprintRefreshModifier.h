...
- (_Bool)hasContentsOfBlueprintChangedWithDiff:(id)arg1 leftBlueprint:(id)arg2 rightBlueprint:(id)arg3;
...
- (id)initWithFeldsparContext:(id)arg1 feedSettings:(id)arg2 feedDataStorage:(id)arg3 offline:(_Bool)arg4 refreshKind:(unsigned long long)arg5 refreshDetector:(id)arg6 feed:(id)arg7 buttonController:(id)arg8 groupSizeCalculator:(id)arg9;
