...
- (TSBridgedNewsActivity *)unrealizedHeadlineWithArticleID:(NSString *)arg1 articleContext:(TSArticleContext *)arg2 notificationSenderChannelID:(NSString *)arg3 articlePresentationStyle:(long long)arg4 showShareSheet:(_Bool)arg5 forceArticleUpdate:(_Bool)arg6;
- (TSBridgedNewsActivity *)headlineWithHeadlineProviding:(id <FCHeadlineProviding>)arg1 articleContext:(TSArticleContext *)arg2 notificationSenderChannelID:(NSString *)arg3 articlePresentationStyle:(long long)arg4 showShareSheet:(_Bool)arg5 forceArticleUpdate:(_Bool)arg6;
