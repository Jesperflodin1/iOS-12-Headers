...
{
    _Bool _disableContentLoadingTransition;
...
@property(nonatomic) _Bool disableContentLoadingTransition; // @synthesize disableContentLoadingTransition=_disableContentLoadingTransition;
- (void).cxx_destruct;
