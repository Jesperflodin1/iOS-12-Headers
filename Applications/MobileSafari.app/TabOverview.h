...
#import "TabViewDropInteractionHandling-Protocol.h"
...
+ (struct CGSize)_maximumWindowDimensionsForStandardTabOverviewColumns;
...
- (void).cxx_destruct;
- (void)tabViewDropInteractionDidProduceNavigationIntent:(id)arg1 forItem:(id)arg2;
- (id)tabViewDropInteraction:(id)arg1 itemAtPoint:(struct CGPoint)arg2;
- (_Bool)tabViewDropInteraction:(id)arg1 canAcceptDropAtPoint:(struct CGPoint)arg2;
