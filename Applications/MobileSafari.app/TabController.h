...
- (unsigned long long)_maximumSnapshotCacheCapacity;
...
- (void)_updateSnapshotCacheStateWithMaxiumCapacity:(unsigned long long)arg1;
...
- (void)tabOverview:(id)arg1 item:(id)arg2 didProduceNavigationIntent:(id)arg3;
...
- (void)tiltedTabView:(id)arg1 item:(id)arg2 didProduceNavigationIntent:(id)arg3;
