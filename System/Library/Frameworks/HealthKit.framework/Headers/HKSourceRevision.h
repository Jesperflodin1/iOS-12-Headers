...
@interface HKSourceRevision : NSObject <NSSecureCoding, NSCopying> {
	...
	SCD_Struct_HK27 _operatingSystemVersion;
...
@property (readonly) SCD_Struct_HK27 operatingSystemVersion;              //@synthesize operatingSystemVersion=_operatingSystemVersion - In the implementation block
+(BOOL)supportsSecureCoding;
-(id)_initWithSource:(id)arg1 ;
-(id)initWithSource:(id)arg1 version:(id)arg2 ;
-(void)_setVersion:(id)arg1 ;
-(NSString *)productType;
-(SCD_Struct_HK27)operatingSystemVersion;
-(id)initWithSource:(id)arg1 version:(id)arg2 productType:(id)arg3 operatingSystemVersion:(SCD_Struct_HK27)arg4 ;
-(id)init;
