...
@class NSDictionary, NSDate, NSObject, MPNowPlayingInfoCenterArtworkContext, NSMutableDictionary, NSMutableArray, MSVLRUDictionary, MPNowPlayingContentItem, MPArtworkResizeUtility, MSVTimer, NSString, MPCPlaybackEngine;
...
@property (assign,nonatomic,__weak) MPCPlaybackEngine * playbackEngine; 
