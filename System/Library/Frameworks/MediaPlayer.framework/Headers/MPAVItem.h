...
@class AVAsset, NSObject, AVPlayerItem, MPQueueFeeder, MPAVController, NSArray, MPAlternateTracks, MPNowPlayingContentItem, NSError, NSString, MPMediaItem, MPModelGenericObject, MPUContentItemIdentifierCollection, MPCContentItemIdentifierCollection, NSData, NSNumber, MPStoreDownload, MPModelPlayEvent, NSDictionary, AVPlayerItemAccessLog, NSURL;
...
@property (nonatomic,copy,readonly) NSNumber * mpcReporting_privateListeningEnabled; 
...
@property (nonatomic,copy,readonly) NSNumber * mpcReporting_siriInitiated; 
...
-(id<MPCReportingIdentityPropertiesLoading>)mpcReporting_identityPropertiesLoader;
...
-(NSNumber *)mpcReporting_privateListeningEnabled;
-(NSNumber *)mpcReporting_siriInitiated;
