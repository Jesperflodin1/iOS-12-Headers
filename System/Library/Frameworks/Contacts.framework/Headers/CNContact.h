...
@class NSArray, NSString, NSDateComponents, NSDate, NSData, CNActivityAlert, NSDictionary, CNContactKeyVector, NSURL, NSPersonNameComponents, SGRecordId, NSSet;

@interface CNContact : NSObject <TUSearchResult, ABSCNLegacyIdentifiable, NSItemProviderReading, NSItemProviderWriting, CNSuggested, CNContactAugmentation, CNObjectValidation, NSCopying, NSMutableCopying, NSSecureCoding> {
