...
@class NSObject, NSXPCInterface, NSString, NSXPCListenerEndpoint, NSSet;
...
@property (nonatomic,copy,readonly) NSString * cx_bundleIdentifier; 
...
@property (nonatomic,copy,readonly) NSString * processBundleIdentifier; 
