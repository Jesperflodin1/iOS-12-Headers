...
-(id)initWithLinearExpression:(SCD_Struct_NS87*)arg1 priority:(double)arg2 engine:(id)arg3 ;
...
-(void)addExpression:(SCD_Struct_NS87*)arg1 priority:(double)arg2 times:(double)arg3 processVarNewToReceiver:(/*^block*/id)arg4 processVarDroppedFromReceiver:(/*^block*/id)arg5 ;
...
-(void)replaceVar:(os_unfair_lock_s)arg1 withExpression:(SCD_Struct_NS87*)arg2 processVarNewToReceiver:(/*^block*/id)arg3 processVarDroppedFromReceiver:(/*^block*/id)arg4 ;
