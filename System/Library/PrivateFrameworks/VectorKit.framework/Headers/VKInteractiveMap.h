...
-(SCD_Struct_VK53*)convertPointToCoordinate:(CGPoint)arg1;
-(SCD_Struct_VK53*)convertPointToMapPoint:(CGPoint)arg1;
-(CGPoint*)convertMapPointToPoint:(SCD_Struct_VK53)arg1;
-(CGPoint*)convertCoordinateToPoint:(SCD_Struct_VK53)arg1;
-(CGPoint*)convertCoordinateToCameraModelPoint:(SCD_Struct_VK53)arg1;
-(id)persistentOverlays;
-(void)transitionToTracking:(BOOL)arg1 mapMode:(long long)arg2 startLocation:(SCD_Struct_VK53)arg3 startCourse:(double)arg4 cameraController:(id)arg5 pounceCompletionHandler:(/*^block*/id)arg6;
