...
- (void)setUIProfileInstallationEnabled:(_Bool)arg1;
- (void)workerQueueSetUIProfileInstallationEnabled:(_Bool)arg1;
- (void)checkProfileInstallationSpeedBump;
- (void)workerQueueCheckProfileInstallationSpeedBump;
...
- (void)_findDataSIMContextWithClient:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)setDictationAllowed:(_Bool)arg1 senderPID:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)showPromptForWatchWith:(id)arg1;
- (void)showPromptForHomePodFor:(id)arg1 with:(id)arg2;
- (void)showPromptForHomePodAndWatchFor:(id)arg1 with:(id)arg2;
- (void)showPromptForPhoneAndOtherDevicesFor:(id)arg1 with:(id)arg2;
- (void)proceedWithHomePodProfileInstallation:(id)arg1;
- (void)obtainConsentForProfile:(id)arg1 completion:(CDUnknownBlockType)arg2;
