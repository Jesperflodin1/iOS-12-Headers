...
* on Saturday, March 2, 2019 at 4:51:56 AM Central European Standard Time
...
@interface HDRProcessor : NSObject {
	...
	SCD_Struct_HD21* _edrMetaData[2];
	...
	SCD_Struct_HD22* _configurationParameters;
...
+(void)dolbyIOMFBMetadata:(SCD_Struct_HD27*)arg1 withMinBrightness:(float)arg2 maxBrightness:(float)arg3 ;
...
-(long long)generateMSRColorConfigWithOperation:(unsigned)arg1 config:(SCD_Struct_HD31*)arg2 inputSurface:(IOSurfaceRef)arg3 outputSurface:(IOSurfaceRef)arg4 metadata:(id)arg5 histogram:(RgbHistogram_t*)arg6 ;
...
-(void)processFrameInternalWithLayer0:(IOSurfaceRef)arg1 layer1:(IOSurfaceRef)arg2 outout:(IOSurfaceRef)arg3 metadata:(id)arg4 commandbuffer:(id)arg5 operation:(unsigned)arg6 config:(SCD_Struct_HD31*)arg7 histogram:(RgbHistogram_t*)arg8 ;
-(BOOL)hasMetalDeviceChanged:(id)arg1 ;
-(long long)ValidateMSRColorConfigInput:(unsigned)arg1 config:(SCD_Struct_HD31*)arg2 inputSurface:(IOSurfaceRef)arg3 outputSurface:(IOSurfaceRef)arg4 metadata:(id)arg5 histogram:(RgbHistogram_t*)arg6 ;
-(void)extractCAMetaData:(id)arg1 withRPU:(BOOL)arg2 ;
-(void)checkIOSurface:(IOSurfaceRef)arg1 forInfoFrame:(SCD_Struct_HD18*)arg2 withRPUData:(BOOL)arg3 ;
-(unsigned)selectHDRUsage;
-(void)setHDRControl:(SCD_Struct_HD34*)arg1 withRUP:(BOOL)arg2 ;
-(void)extractFrameMetadata:(CFDictionaryRef)arg1 intoTCControl:(ToneCurve_Control*)arg2 ;
-(long long)processPixelsWithLayer0:(IOSurfaceRef)arg1 layer1:(IOSurfaceRef)arg2 output:(IOSurfaceRef)arg3 metaData:(SCD_Struct_HD38*)arg4 tcControl:(ToneCurve_Control*)arg5 hdrControl:(SCD_Struct_HD34*)arg6 hdr10InfoFrame:(SCD_Struct_HD18*)arg7 commandbuffer:(id)arg8 ;
-(void)extractHEVCHDRParameterFromInputIOSurface:(IOSurfaceRef)arg1 forInfoFrame:(SCD_Struct_HD18*)arg2 ;
-(void)setCSCMatrixInHDRControl:(SCD_Struct_HD34*)arg1 forIndex:(unsigned)arg2 ;
