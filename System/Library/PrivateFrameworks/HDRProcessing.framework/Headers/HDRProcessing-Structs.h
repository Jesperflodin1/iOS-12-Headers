...
typedef struct {
	...
	unsigned field15;
	float field16;
	SCD_Struct_HD5 field17;
	SCD_Struct_HD6 field18;
	int field19;
} SCD_Struct_HD7;
...
typedef struct {
	...
	SCD_Struct_HD20 dmData;
	ToneCurve_Control tcControl;
	SCD_Struct_HD15 hdrControl;
	SCD_Struct_HD18 infoFrameData;
} SCD_Struct_HD21;
...
typedef struct {
	...
	ToneCurve_Control field2;
	SCD_Struct_HD34 field3;
	SCD_Struct_HD36 field4;
	SCD_Struct_HD37 field5;
	8 field6;
} SCD_Struct_HD38;
...
typedef struct ChromaticAdaptation_t {
	...
	SCD_Struct_MS48 toneMapMode0;
	SCD_Struct_MS49 toneMapMode1;
	SCD_Struct_MS50) toneMapMode2;
...
typedef struct {
	SCD_Struct_MS63 output_conversion;
} SCD_Struct_MS64;
...
typedef struct {
	float degammaLUTforCModel[514];
	int degammaLUT[3][514];
	float pq2lLUTforCModel[514];
	int pq2lLUT[3][514];
} SCD_Struct_MS66;
...
typedef union {
	unsigned lut[4][513];
	SCD_Struct_MS67 cmodel;
} SCD_Union_MS68;

typedef struct {
	float regammaLUTforCModel[706];
	float regammaLUT[3][706];
	float l2pqLUTforCModel[706];
	float l2pqLUT[3][706];
} SCD_Struct_MS69;
