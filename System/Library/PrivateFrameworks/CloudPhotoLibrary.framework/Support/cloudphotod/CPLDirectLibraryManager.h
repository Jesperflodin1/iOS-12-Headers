...
- (id)safeResourcesToDeleteFromProposedResources:(id)arg1 checkServerIfNecessary:(_Bool)arg2 allowUnconfirmed:(_Bool)arg3 resourcesToCheckOnServer:(id *)arg4 transportScopes:(id *)arg5 unsafeResources:(id)arg6;
