...
- (id <CPLEngineTransportSetupTask>)setupTaskUpdateDisabledFeatures:(_Bool)arg1 completionHandler:(void (^)(id <CPLEngineStoreUserIdentifier>, NSArray *, NSError *))arg2;
@end
