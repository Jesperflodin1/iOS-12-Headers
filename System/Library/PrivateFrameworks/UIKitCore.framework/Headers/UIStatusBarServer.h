...
+(id)_cachedTimeStringFromData:(SCD_Struct_UI86*)arg1 ;
+(void)postStatusBarData:(const SCD_Struct_UI86*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI89*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(const SCD_Struct_UI86*)getStatusBarData;
+(SCD_Struct_UI89*)getStatusBarOverrideData;
...
-(void)_receivedStatusBarData:(SCD_Struct_UI86*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
