...
-(id)_initWithConnectionInfo:(SCD_Struct_UI103)arg1 serviceBundleIdentifier:(id)arg2 deputyInterfaces:(id)arg3 ;
-(id)_initWithConnectionInfo:(SCD_Struct_UI103)arg1 service:(id)arg2 deputyInterfaces:(id)arg3 ;
-(void)_terminateUnconditionallyThen:(/*^block*/id)arg1 ;
-(id)_terminateWithError:(id)arg1 ;
-(id)_initWithConnectionInfo:(SCD_Struct_UI103)arg1 serviceBundleIdentifier:(id)arg2 service:(id)arg3 deputyInterfaces:(id)arg4 ;
