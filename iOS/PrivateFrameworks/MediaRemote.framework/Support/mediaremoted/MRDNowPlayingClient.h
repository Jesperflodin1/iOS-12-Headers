...
@interface MRDNowPlayingClient : NSObject
{
    ...
    _Bool _pushStateAnyPlayerIsPlaying;
...
@property(nonatomic) _Bool pushStateAnyPlayerIsPlaying; // @synthesize pushStateAnyPlayerIsPlaying=_pushStateAnyPlayerIsPlaying;
