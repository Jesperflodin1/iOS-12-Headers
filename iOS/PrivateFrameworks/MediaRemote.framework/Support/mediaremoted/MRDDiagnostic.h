...
@class MRApplicationActivity, MRDMediaRemoteClient, MROutputContextDataSource, NSArray, NSDate, NSDictionary, NSString, _MRAVAirPlaySecuritySettingsProtobuf, _MROriginProtobuf;

@interface MRDDiagnostic : NSObject
{
    unsigned int _nowPlayingPlaybackState;
...
@property(nonatomic) unsigned int nowPlayingPlaybackState; // @synthesize nowPlayingPlaybackState=_nowPlayingPlaybackState;
