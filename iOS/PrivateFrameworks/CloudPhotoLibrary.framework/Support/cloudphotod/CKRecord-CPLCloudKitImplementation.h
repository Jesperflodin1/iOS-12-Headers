...
- (_Bool)cplAddResourcesFromChange:(id)arg1 scopeProvider:(id)arg2 clearMissing:(_Bool)arg3 error:(id *)arg4;
- (id)cplResourcesWithScopedIdentifier:(id)arg1 coherent:(_Bool *)arg2;
