...
@class HFAssociatedServiceTypeOptionItemProvider, HFItem, HFItemBuilder, HFRoomBuilder, HFStaticItemProvider, HFTransformItemProvider, HSSetupServiceSelectedRoomItemProvider, HUValveItemModule, NSArray, NSSet;
