...
@class CarAccessoriesOverlay, CarAlertViewController, CarCardsOverlay, CarChromeState, CarDebugFramesView, CarMapControlsOverlay, CarMapNudgerizer, CarMapSettings, CarMapsFocusGuide, CarNavigationController, CarNavigationDisplay, CarOverlayController, CarRouteGeniusAnnotationsManager, CarRouteGeniusManager, CustomPOIsController, DirectionsController, DirectionsManager, GEOMapServiceTraits, MKMapView, MapCameraController, NSArray, NSHashTable, NSMapTable, NSString, NSTimer, ParkedCarManager, PersonalizedItemManager, RouteAnnotationsController, SearchPinsManager, UILayoutGuide, UITapGestureRecognizer, UIView, UIViewController;
