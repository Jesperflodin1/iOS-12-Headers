...
{
    long long _autocompleteCategoryPriority;
    id _object;
    long long _objectPriority;
    NSSet *_keys;
    MKMapItem *_mapItem;
    long long _order;
    NSString *_title;
...
- (id)initWithLocalCompletion:(id)arg1 withOrder:(long long)arg2 matchInfo:(id)arg3;
- (id)initWithServerCompletion:(id)arg1 withOrder:(long long)arg2;
- (id)init;
